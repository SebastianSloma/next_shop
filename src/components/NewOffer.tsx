...
const NewOffer = () => {
	return (
		<div id='newoffer' className='container pt-16 mb-5'>
			<h2 className='mb-8 font-medium text-8xl max-sm:text-6xl pb-4'>New <span className='class="font-extrabold text-transparent text-8xl max-sm:text-6xl bg-clip-text bg-gradient-to-r from-orange-300 to-orange-600'>Offers</span></h2>
